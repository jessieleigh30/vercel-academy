          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
              {featuredItems.slice(0, 6).map((item) => (
                <div
                  key={item.id}
                  className="group relative bg-white border border-gray-100 hover:border-blue-200 transition-all duration-500 hover:scale-[1.02]"
                >
                  ...
                  <div className="p-8">
                    <div className="flex items-center gap-3 mb-4">
                      <span
                        className="inline-flex items-center px-3 py-1 text-xs font-bold uppercase tracking-wider bg-blue-600 text-white"
                        style={{ fontFamily: 'var(--font-display)' }}
                      >
                        Featured
                      </span>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            {regularItems.map((item) => (
              <div
                key={item.id}
                className="group relative bg-white border border-gray-100 hover:border-blue-200 transition-all duration-300 hover:scale-[1.02]"
              >
                <div className="aspect-w-16 aspect-h-9 overflow-hidden">
                  <Image
                    src={item.thumbnailUrl}
