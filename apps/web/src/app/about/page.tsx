        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:max-w-none">
            <div className="text-center">
              ...
              <p className="mt-4 text-lg leading-8 text-gray-600">Numbers that tell our story</p>
            </div>
            <StatsGrid columns={4} className="mt-16">
              <StatsCard value={`${companyStats.yearsInBusiness}+`} label="Years in Business" />
              <StatsCard value={companyStats.employeeCount} label="Team Members" />
              <StatsCard value={companyStats.projectsCompleted} label="Projects Completed" />
              <StatsCard value={`${companyStats.satisfactionRate}%`} label="Client Satisfaction" />
            </StatsGrid>
          </div>
        </div>
      </div>
