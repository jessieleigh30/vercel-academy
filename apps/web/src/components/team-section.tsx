              ...
              <div key={member.id} className={cardClass}>
                <div className="p-8 h-full flex flex-col text-center">
                  ...
                  <div className="flex-1">
                    <h3
                      className="text-2xl font-black uppercase tracking-tighter leading-tight mb-2 text-gray-900 group-hover:text-white transition-colors duration-700"
                      style={{ fontFamily: 'var(--font-display)' }}
                    >
                      {member.name}
                    </h3>
                    <p
                      className="text-lg font-medium mb-1 text-blue-600 group-hover:text-blue-300 transition-colors duration-700"
                      style={{ fontFamily: 'var(--font-body)' }}
                    >
                      {member.role}
                    </p>
                    <p
                      className="text-sm uppercase tracking-wide mb-6 text-gray-600 group-hover:text-gray-400 transition-colors duration-700"
                      style={{ fontFamily: 'var(--font-display)' }}
                    >
                      {member.department}
                    </p>
                    ...
                    {/* Experience & Skills */}
                    <div
                      className="text-sm font-medium mb-6 text-gray-700 group-hover:text-gray-300 transition-colors duration-700"
                      style={{ fontFamily: 'var(--font-body)' }}
                    >
