    ...
    <header className="sticky top-0 z-50 bg-gray-900/95 backdrop-blur-sm border-b border-gray-700">
      <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end">
          <Link
            href="/contact"
            className="rounded-full bg-gradient-to-r from-violet-500 to-fuchsia-500 px-6 py-2 text-sm font-semibold text-white shadow-lg hover:from-violet-400 hover:to-fuchsia-400 hover:scale-105 active:scale-95 transition-all duration-200"
          >
            Get Started 🎯
          </Link>
        </div>
            ...
            <div className="mt-6 flow-root">
              <div className="-my-6 divide-y divide-gray-700">
                ...
                <div className="py-6">
                  <Link
                    href="/contact"
                    className="-mx-3 block rounded-lg px-3 py-2.5 text-base font-semibold leading-7 text-white bg-gradient-to-r from-violet-500 to-fuchsia-500 hover:from-violet-400 hover:to-fuchsia-400"
                    onClick={() => setMobileMenuOpen(false)}
                  >
                    Get Started 🎯
                  </Link>
